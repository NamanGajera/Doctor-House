                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        GestureDetector(
                                          onTap: () {
                                            setState(() {
                                              if (favoriteHospitals.contains(index)) {
                                                favoriteHospitals.remove(index);
                                              } else {
                                                favoriteHospitals.add(index);
                                              }
                                            });
                                          },
                                          child: Icon(
                                            favoriteHospitals.contains(index) ? Icons.favorite : Icons.favorite_border,
                                            color: favoriteHospitals.contains(index) ? Colors.red : Colors.grey,
                                            size: 22,
                                          ),
                                        ),
                                      ],
